...
namespace Motor {
    ...
    public:
        ...
        MassiveObject2D(ldouble mass, glm::vec2 pos, GLFWwindow* parent_window, Renderer& renderer, glm::vec2 initial_velocity = glm::vec2(0, 0), glm::vec2 initial_acceleration = glm::vec2(0, 0));
